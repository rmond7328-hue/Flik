export const colors = {
  background: '#FFFFFF', surface: '#F7F8FA', surfaceStrong: '#F1F3F5', text: '#111111', muted: '#6B7280', subtle: '#9CA3AF', border: '#E8EAED', accent: '#60A5FA', accentStrong: '#3B82F6', accentSoft: '#EAF4FF', danger: '#EF4444', success: '#16A34A', white: '#FFFFFF',
} as const;
...
export const shadow = { card: { shadowColor: '#000000', shadowOpacity: 0.06, shadowRadius: 14, shadowOffset: { width: 0, height: 5 }, elevation: 2 } } as const;
